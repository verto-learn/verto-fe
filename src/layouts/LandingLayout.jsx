...
export const LandingLayout = () => {
  return (
    <div className="relative min-h-screen overflow-hidden bg-primary text-white">
      ...
      <div className="aurora absolute bottom-[72vh] right-0  w-[600px] h-[600px] bg-gradient-to-tr from-accent via-cyan-400 to-purple-400 rounded-full blur-2xl opacity-25 animate-aurora3" />
      <div className="aurora absolute bottom-[112vh] left-0  w-[500px] h-[500px] bg-gradient-to-tr from-accent via-cyan-400 to-purple-400 rounded-full blur-2xl opacity-25 animate-aurora3" />
