        ...
        <section className="min-h-screen flex items-center justify-center">
            <div className='text-center'>
                ...
                <div className='flex gap-4 justify-center'>
                    <button onClick={toLogin} className='hover:bg-secondary transition-all gap-x-2 hover:scale-110  duration-500 ease-in-out px-6 py-2 rounded-2xl border border-secondary flex items-center'>
                        Start Now
                        <MoveUpRight size={15} />
                    </button>
