...
export const LandingLayout = () => {
  return (
    <div className="relative min-h-screen overflow-hidden bg-primary text-white">
      <div className="aurora absolute -top-40 -left-40 w-[600px] h-[600px] bg-gradient-to-br from-secondary via-accent to-light rounded-full blur-3xl opacity-30 animate-aurora1" />
